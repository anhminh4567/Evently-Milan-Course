...
public static class DomainEventHandlersFactory
{
    ...
    public static IEnumerable<IDomainEventHandler> GetHandlers(
        Type type, // message type ( Domain Event type )
        IServiceProvider serviceProvider,// scoped
        Assembly assembly) // scan the assembly of the implementation of the respective interface and type
    {
