...
{
    protected static readonly Assembly ApplicationAssembly = typeof(Events.Application.MetaClass).Assembly;
    ...
    protected static readonly Assembly PresentationAssembly = typeof(Events.Presentation.MetaClass).Assembly;
}
