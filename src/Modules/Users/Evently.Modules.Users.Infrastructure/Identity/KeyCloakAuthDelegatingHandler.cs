...
internal sealed class KeyCloakAuthDelegatingHandler : DelegatingHandler
{
    ...
    private readonly IOptions<KeyCloakOptions> _bindedOptions;

    public KeyCloakAuthDelegatingHandler(IOptions<KeyCloakOptions> bindedOptions)
    {
        _bindedOptions = bindedOptions;
        _options = _bindedOptions.Value;
    }
    ...
    {
        // get access token by callling to Keycloak endponit
        // as confidential client ( server to server method )
        ...
        // ------------------------- before sending interceptors ------------------------- 
        HttpResponseMessage httpResponseMessage = await base.SendAsync(request, cancellationToken);
        // ------------------------- after sending interceptors ------------------------- 
